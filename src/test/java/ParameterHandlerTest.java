...
// Probs could delete that empty setup block

// Split up dem crazy long strings like so:
//    String longString = "/parameters?variable_1=Operators%20%3C%2C%20%3E%2C%20%3D%2C%20!" +
//        "%3D%3B%20%2B%2C%20-%2C%20*%2C%20%26%2C%20%40%2C%20%23%2C%20%24%2C%20%5B%2C%20%5D%3A%20" +
//        "%22is%20that%20all%22%3F&variable_2=stuff"
//    new Request("GET", new URI(longString), "HTTP/1.1");

// Your handler is shared between tests - shared state between tests could lead to weird fails
// Better to either slip it into the before block or just define it anew each test. As easy as this:

//         Response response = handler.handle(request);
//                              =>
//         Response response = new ParameterHandler().handle(request);

// Does your core server have any way of handling/parsing query strings? If so, does your core
// server have tests of it? 'cause that aspect isn't cob_spec specific.
